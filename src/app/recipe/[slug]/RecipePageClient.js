...
function smartRound(amount, unit) {
  const countables = [
    'large', 'medium', 'small', 'cloves', 'clove', 'egg', 'eggs', 'onion', 'onions',
    'banana', 'bananas', 'piece', 'pieces', 'fillet', 'fillets', 'drumstick', 'drumsticks', 'leg', 'legs',
  ];
...
export default function RecipePageClient({ params }) {
