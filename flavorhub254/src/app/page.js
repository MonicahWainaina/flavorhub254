  ...
  <div className="max-w-7xl mx-auto flex items-center px-4 py-4 sm:py-6 justify-between">
    ...
    <div className="hidden md:flex flex-1 items-center justify-end gap-x-8 ml-8">
      ...
      <nav className="flex gap-x-6">
        <Link href="/" className="capitalize hover:text-green-500 transition text-base cursor-pointer">Home</Link>
        <Link href="/browse" className="capitalize hover:text-green-500 transition text-base cursor-pointer">Browse recipes</Link>
        <Link href="/flavorbot" className="capitalize hover:text-green-500 transition text-base cursor-pointer">Ask FlavorBot</Link>
      </nav>
      {/* Search & Login/Signup */}
  ...
  {mobileNavOpen && (
    <div className="fixed top-0 left-0 w-full bg-[#181818] bg-opacity-95 z-[999] flex flex-col items-center py-8 px-6 rounded-b-2xl shadow-lg md:hidden transition-all"
      ...
      <nav className="flex flex-col gap-6 text-center mt-4 w-full">
        <Link href="/" className="text-xl text-white font-semibold cursor-pointer" onClick={() => setMobileNavOpen(false)}>Home</Link>
        <Link href="/browse" className="text-xl text-white font-semibold cursor-pointer" onClick={() => setMobileNavOpen(false)}>Browse recipes</Link>
        <Link href="/flavorbot" className="text-xl text-white font-semibold cursor-pointer" onClick={() => setMobileNavOpen(false)}>Ask FlavorBot</Link>
        <Link href="/contact" className="text-xl text-white font-semibold cursor-pointer" onClick={() => setMobileNavOpen(false)}>Login/Signup</Link>
      </nav>
    </div>
  )}
</header>
