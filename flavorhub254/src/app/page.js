        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-4 md:px-8 lg:px-12 xl:px-0 relative gap-10 w-full">
          ...
          <div className="flex-1 flex flex-col lg:max-w-[600px] md:max-w-[700px] md:items-center sm:items-start lg:items-start justify-start z-10 relative mb-10 lg:mb-0">
            <div className="
              relative w-full
              max-w-full
              md:max-w-[520px]  // <-- wider on tablet
              lg:max-w-[400px]  // <-- original on desktop
              flex flex-col
              items-center
              lg:items-start
            ">
              <h1 className="
                ...
                text-center
                lg:text-left
                md:max-w-[520px] // <-- match card width on tablet
                lg:max-w-[400px] // <-- original on desktop
                mx-auto
              ">
                Kenya’s Smart <br className="block lg:block md:hidden" /> Recipe Library
              </h1>
              <p className="
